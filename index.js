...
var randonNumber = Math.floor(Math.random()*arrayOfQuotes.length);

document.getElementById('quoteText').innerHTML = arrayOfQuotes[randonNumber].quote;
document.getElementById('quoteAuthor').innerHTML = '~ By ' + arrayOfQuotes[randonNumber].author;
}